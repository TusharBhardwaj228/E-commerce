...
export function renderOrderSummary(){
  ...
  cart.forEach((cartItem)=>{
    ...
    const dates = calculateDeliveryDate(deliveryOption);
  ...
  document.querySelector('.js-order-summary').innerHTML = checkHTML;
  const returnHome = document.querySelector('.js-return-to-home-link');
